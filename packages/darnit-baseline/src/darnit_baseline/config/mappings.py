...
DEFAULT_FILE_LOCATIONS: dict[str, list[str]] = {
    ...
    "security.policy": ["SECURITY.md", "security.md", ".github/SECURITY.md", "docs/SECURITY.md", "docs/security.md"],
    ...
    "security.secrets_policy": ["docs/SECRETS.md", "docs/secrets.md", "SECRETS.md", "docs/security/SECRETS.md"],
    ...
    "governance.codeowners": ["CODEOWNERS", ".github/CODEOWNERS", "docs/CODEOWNERS"],
    "governance.governance_doc": ["GOVERNANCE.md", "governance.md", "docs/GOVERNANCE.md", ".github/GOVERNANCE.md"],
    ...
    # Legal documentation
    "legal.license": ["LICENSE", "LICENSE.md", "LICENSE.txt", "license", "COPYING"],
    "legal.dco": ["DCO", "DCO.md", ".github/DCO", ".github/DCO.md"],
    "legal.cla": ["CLA", "CLA.md", ".github/CLA", ".github/CLA.md"],
    # Quality documentation (extension fields)
    "quality.changelog": ["CHANGELOG.md", "CHANGELOG", "changelog.md", "HISTORY.md", "docs/CHANGELOG.md", "CHANGES.md"],
    # Project documentation (standard fields)
    "documentation.readme": ["README.md", "README", "readme.md", "README.rst"],
    "documentation.support": ["SUPPORT.md", "support.md", ".github/SUPPORT.md", "docs/SUPPORT.md"],
    ...
    "documentation.api": ["docs/API.md", "docs/api.md", "API.md", "docs/api/README.md", "api/README.md"],
    # Build artifacts (extension fields)
    "artifacts.sbom": ["sbom.json", "sbom.xml", ".sbom/sbom.json", "bom.json", "sbom.spdx.json", "sbom.cdx.json"],
    ...
    "dependencies.docs": ["DEPENDENCIES.md", "dependencies.md", "docs/DEPENDENCIES.md", "docs/dependencies.md"],
    # Testing documentation
    "testing.docs": ["docs/TESTING.md", "docs/testing.md", "TESTING.md", "test/README.md", "tests/README.md"],
    # Release documentation
    "releases.docs": ["docs/RELEASING.md", "docs/releasing.md", "RELEASING.md", "docs/RELEASE.md"],
    # CI/CD configurations - GitHub
    "ci.github.dependabot": [".github/dependabot.yml", ".github/dependabot.yaml"],
    "ci.github.dco_config": [".github/dco.yml", ".github/dco.yaml"],
    "ci.github.codeql": [
    ...
    "ci.gitlab": [".gitlab-ci.yml", ".gitlab-ci.yaml"],
    "ci.circleci": [".circleci/config.yml", ".circleci/config.yaml"],
    "ci.jenkins": ["Jenkinsfile", "jenkins/Jenkinsfile"],
    "ci.travis": [".travis.yml", ".travis.yaml"],
    "ci.azure": ["azure-pipelines.yml", "azure-pipelines.yaml", ".azure-pipelines/azure-pipelines.yml"],
}
